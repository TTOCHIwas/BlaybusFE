        ...
        <Box animation="fadeIn 0.3s">
            ...
            <VStack spacing={3} align="stretch">
                {worksheets.map((worksheet) => (
                    <Flex key={worksheet.id} gap={10} align="flex-start">
                        {/* Left Column: File Input/Display Box */}
                        <Box flex={1}>
                            <Box
                                h="50px"
                                border="1px solid"
                        ...
                        {/* Right Column: Day Distribution Buttons */}
                        <Box flex={1}>
                            <HStack spacing={2} h="50px" align="center">

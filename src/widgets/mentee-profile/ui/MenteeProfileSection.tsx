...
import {
  ...
  IconButton, Button, ButtonGroup, Heading
          ...
          >
            ...
            >
              <HStack align="baseline" mb={{ base: 4, md: 6 }} spacing={3}>
                <Text fontSize={{ base: "2xl", md: "28px" }} fontWeight="extrabold" color="gray.800">
                  {profile.name}님
                </Text>
                <Text fontSize={{ base: "md", md: "18px" }} color="gray.500" fontWeight="medium">
